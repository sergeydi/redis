///// Internal `KeyedDecodingContainerProtocol` for `RedisDataDecoder`
//final class RedisDataKeyedDecodingContainer<K>: KeyedDecodingContainerProtocol
//    where K: CodingKey 
//{
...
//
//    /// Creates a new internal `RedisDataKeyedDecodingContainer`.
...
//        let container = RedisDataKeyedDecodingContainer<NestedKey>(partialData: partialData, at: codingPath + [key])
...
//        return _RedisDataDecoder(partialData: partialData, at: codingPath + [key])
//    }
//}
